let musicas = [
  {
    titulo: 'Enough',
    artista: 'Julia Pereira',
    source: 'musicas/Enough - rock.mp3',
    img: 'imagens/rock.jpg'
  },
  {
    titulo: 'pop',
    artista: 'Julia Pereira',
    source: 'musicas/As You Fade Away - pop.mp3',
    img: 'imagens/pop.jpg'
  },
  {
    titulo: 'Cafe Regrette',
    artista: 'Julia Pereira',
    source: 'musicas/Cafe Regrette - classica.mp3',
    img: 'imagens/classica.jpg'
  },
  {
    titulo: 'Warzone',
    artista: 'Julia Pereira',
    source: 'musicas/ Warzone - hip-hop.mp3',
    img: 'imagens/hip-hop.jpg'
  }
]

// INICIO
let musica = document.querySelector('audio') //let =  variavel
let musicaIndex = 0
